...
{
    public class OpenItemPoController : Controller
    {
        private IMenu _menu;
        private IUser _user;
        ...
        public OpenItemPoController(IMenu menu, IUser user, IOpenItemPo open_item_po, IHttpContextAccessor httpContextAccessor, IStringLocalizer<HomeController> localizer, IOptions<Helpers.AppSettings> appSettings)
        {
            _menu = menu;
            _user = user;
            ...
            _permission = _menu.GetPermission("OpenItemPo", httpContextAccessor.HttpContext.Session.GetString("role_id"));
        }
        ...
        public IActionResult LoadOpenItemPoData(PostDatatableNetModel datatable_params)
        {
            try
            {
                ...
                {
                    "po_item_number", "doc_date", "po_number", "po_name", "po_quantity", "uom", "currency", "net_price", "name_vendor"
                };
